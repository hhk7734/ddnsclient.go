...
import (
	...
	"github.com/hhk7734/ddnsclient.go/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "7d8ee235.loliot.net",
	...
	if err := (&controller.DDNSReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "DDNS")
		os.Exit(1)
	}
